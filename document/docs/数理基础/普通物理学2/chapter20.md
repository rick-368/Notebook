...
$$
|H\rangle = \frac{|R\rangle + |L\rangle}{\sqrt{2}} = \frac{1}{\sqrt{2}} \left[ \frac{1}{\sqrt{2}} \begin{pmatrix} 1 \cr -i \end{pmatrix} + \frac{1}{\sqrt{2}} \begin{pmatrix} 1 \cr i \end{pmatrix} \right]
$$

- 这种概率性解释同样适用于对角偏振光：
$$
|D\rangle = \frac{1}{\sqrt{2}} \begin{pmatrix} 1 \cr 1 \end{pmatrix} = \frac{|H\rangle + |V\rangle}{\sqrt{2}}
$$
$$
|A\rangle = \frac{1}{\sqrt{2}} \begin{pmatrix} 1 \cr -1 \end{pmatrix} = \frac{|H\rangle - |V\rangle}{\sqrt{2}}
$$
